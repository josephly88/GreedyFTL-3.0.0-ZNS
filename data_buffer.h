...
#define TOTAL_BUFFER_COUNT								(AVAILABLE_DATA_BUFFER_ENTRY_COUNT + OPEN_ZONE_DATA_BUFFER_ENTRY_COUNT + ACTIVE_ZONE_READ_BUFFER_ENTRY_COUNT)
...
typedef struct _DATA_BUF_MAP{
	DATA_BUF_ENTRY dataBuf[TOTAL_BUFFER_COUNT];
