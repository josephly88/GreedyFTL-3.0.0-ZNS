...
#define TEMPORARY_DATA_BUFFER_BASE_ADDR			(DATA_BUFFER_BASE_ADDR + TOTAL_BUFFER_COUNT * BYTES_PER_DATA_REGION_OF_SLICE)
...
#define BUFFER_QUEUE_MAP_ADDR                    (UNI_BUF_REG_ADDR + sizeof(UNI_BUF_REG))

#define ZNS_MANAGEMENT_END_ADDR			        (UNI_BUF_REG_ADDR + sizeof(UNI_BUF_REG) - 1)
