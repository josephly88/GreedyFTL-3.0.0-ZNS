...
#define TEMPORARY_DATA_BUFFER_BASE_ADDR			(DATA_BUFFER_BASE_ADDR + (AVAILABLE_DATA_BUFFER_ENTRY_COUNT + AVAILABLE_ZNS_DATA_BUFFER_ENTRY_COUNT) * BYTES_PER_DATA_REGION_OF_SLICE)
