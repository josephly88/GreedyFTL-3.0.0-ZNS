...
#define VALID_BLOCK_SHUFFLE_LIST_ADDR   0x0ED00000
...
#define TEMPORARY_DATA_BUFFER_BASE_ADDR			(DATA_BUFFER_BASE_ADDR + (AVAILABLE_DATA_BUFFER_ENTRY_COUNT + OPEN_ZONE_DATA_BUFFER_ENTRY_COUNT + ACTIVE_ZONE_READ_BUFFER_ENTRY_COUNT) * BYTES_PER_DATA_REGION_OF_SLICE)
